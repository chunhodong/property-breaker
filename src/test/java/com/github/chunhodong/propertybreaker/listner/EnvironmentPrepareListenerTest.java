package com.github.chunhodong.propertybreaker.listner;

import com.github.chunhodong.propertybreaker.app.PropertyBreakerApplication;
import com.github.chunhodong.propertybreaker.listener.EnvironmentPrepareListener;
...
public class EnvironmentPrepareListenerTest {
    ...
    void applicationContext준비(){
        ...
        clazz = PropertyBreakerApplication.class;
    ...
    void hibernate_ddlauto_설정이create인경우_예외발생(){
        ...
        assertThrows(IllegalArgumentException.class,() -> target.onApplicationEvent(event));
    }
    ...
    private ConfigurableEnvironment getEnvironment(){
        return new ConfigurableEnvironment() {
            ...
            public MutablePropertySources getPropertySources() {
                ...
                String detectorPropos = "chunhodong.property-breaker.hibernate-ddlauto-deactive";
